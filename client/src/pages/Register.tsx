    ...
    return (
        ...
        className="w-1/2 h-screen"/>
            <div className="w-1/2 h-screen flex flex-col justify-center items-center">
                <div className="w-3/4 py-12 flex flex-col gap-20">
                <div className="flex flex-col w-full gap-4">
        	        <h1 className="text-4xl font-bold">Wellcome to <span className=" text-[#FF725C]">DevCourses</span></h1>
                    <p className="text-gray-500 font-medium text-sm">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit similique <br /> tempora deleniti recusandae accusamus.</p>
                </div>
